...
def train():
    with tf.device('/cpu:0'):
        e1_list, e2_list, pos1, pos2, between, before, after, y = data_helpers.load_data_and_labels(FLAGS.train_dir,FLAGS.max_sentence_length,mode='train')
    ...
    e1_list, e2_list, pos1, pos2, between, before, after, y = data_helpers.load_data_and_labels(FLAGS.eval_dir,FLAGS.max_sentence_length,mode='eval')
    ...
    with open('./ans/ans_xgb_between_before_after.txt','w') as f:
