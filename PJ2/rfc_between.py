...
def train():
    with tf.device('/cpu:0'):
        e1_list, e2_list, pos1, pos2, between, y = data_helpers.load_data_and_labels(FLAGS.train_dir, mode='train')
    ...
    with tf.device('/cpu:0'):
        e1_list, e2_list, pos1, pos2, between, y = data_helpers.load_data_and_labels(FLAGS.eval_dir, mode='eval')
    ...
    with open("ans_rfc_between.txt", "w") as fout:
