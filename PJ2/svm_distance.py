...
def train():
    ...
    for idx in range(len(e1_list)):
        ...
        x.append(e1_list[idx]+e2_list[idx]+[pos1[idx]]+[distance[idx]]+[pos2[idx]]+POS_tag_e1[idx]+POS_tag_e2[idx]+between_flatten+before_flatten+after_flatten)
    ...
    with open("ans_svm_distance.txt", "w") as fout:
