...
def test(args):
    ...
    #e1_list, e2_list, pos1, pos2, between, before, after, y = data_helpers.load_data_and_labels(FLAGS.train_dir)
    ...
    #with tf.device('/cpu:0'):
    e1_list, e2_list, pos1, pos2, between, before, after, y = data_helpers.load_data_and_labels(args.eval_dir, mode='eval')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-eval_dir', default="./data/TEST_FILE.txt", help="Path of evaluation data")
