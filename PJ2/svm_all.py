...
def train():
    with tf.device('/cpu:0'):
        pos1, pos2, all_words, y = data_helpers.load_data_and_labels(FLAGS.train_dir, mode='train')
    ...
    with tf.device('/cpu:0'):
        pos1, pos2, all_words, y = data_helpers.load_data_and_labels(FLAGS.eval_dir, mode='eval')
    ...
    with open("ans_svm_all.txt", "w") as fout:
