...
def simpleRNN(args):
    ...
    # Embedding layer
    embeddings_inputs = Embedding(args.vocab_size, 
                                 args.embedding_dim, 
    ...
    """
    # Reshape
    Reshape_embeddings = Reshape((50, 50, 1))(embeddings_inputs)
    # CNN
    CNN_embeddings = Conv2D(32, (5, 5))(Reshape_embeddings)
    # Flatten
    Flatten_embeddings = Flatten()(CNN_embeddings)
    # DNN layer
    outputs = Dense(args.hidden_size//2, 
                    activation='relu')(Flatten_embeddings)
